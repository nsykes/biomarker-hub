...
export function AppShell() {
  ...
  return (
    <>
      ...
      <header className="relative z-50 flex items-center gap-3 safe-pt px-4 pb-3 md:px-6 md:pb-3 border-b border-[var(--color-border-light)] backdrop-blur-lg flex-shrink-0" style={{ background: 'var(--color-header-bg)', boxShadow: 'var(--color-header-shadow)' }}>
