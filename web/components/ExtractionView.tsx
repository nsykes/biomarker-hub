...
export function ExtractionView({ mode, onBack }: ExtractionViewProps) {
  ...
  return (
    <>
      ...
      <header className="flex items-center gap-2 md:gap-3 flex-wrap safe-pt px-3 md:px-4 pb-2.5 md:pb-2.5 border-b border-[var(--color-border-light)] backdrop-blur-lg flex-shrink-0" style={{ background: 'var(--color-header-bg)', boxShadow: 'var(--color-header-shadow)' }}>
        <button
