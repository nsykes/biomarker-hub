        ...
        <div className="flex items-center gap-1.5 min-w-0 flex-wrap">
          ...
          {dataList.some((d) => d.summary) && (
            <div className="relative group/info flex-shrink-0">
              ...
              <div className="invisible group-hover/info:visible absolute top-full left-1/2 -translate-x-1/2 mt-1.5 w-72 max-h-48 overflow-y-auto bg-[var(--color-surface)] border border-[var(--color-border-light)] rounded-xl shadow-lg px-3 py-2.5 z-30">
                {dataList.map((d) =>
                  d.summary ? (
