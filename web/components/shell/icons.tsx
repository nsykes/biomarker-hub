...
function baseProps(active: boolean, size: number) {
  return {
    width: size,
    height: size,
    viewBox: "0 0 24 24",
...
export function SettingsIcon({ active = false, size = 22 }: IconProps) {
  return (
    <svg {...baseProps(active, size)}>
...
export function HamburgerIcon({ size = 22 }: IconProps) {
  return (
    <svg {...baseProps(false, size)}>
