...
export function BiomarkerDetailPage({ data }: { data: BiomarkerDetailData }) {
  ...
  return (
    <div className="min-h-screen overflow-auto bg-[var(--color-surface-secondary)]">
      ...
      <header className="flex items-center gap-3 border-b border-[var(--color-border-light)] bg-white/80 backdrop-blur-lg px-6 py-3" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
        <Link href="/">
