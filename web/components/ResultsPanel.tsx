      ...
      <div className="flex-1 overflow-auto">
        ...
        {extraction && extraction.biomarkers.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full px-6 py-12">
            <div className="flex flex-col items-center gap-3 max-w-sm text-center px-6 py-8 rounded-2xl" style={{ background: '#FFF3E0' }}>
              <svg className="w-10 h-10 text-[#B36B00]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-[#B36B00] font-semibold">No biomarkers found</p>
